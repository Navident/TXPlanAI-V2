...
namespace DentalTreatmentPlanner.Server.Controllers
{
    public class ProvidersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProviderId,LastName,FirstName,Npi,CreatedAt,ModifiedAt")] Provider provider)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProviderId,LastName,FirstName,Npi,CreatedAt,ModifiedAt")] Provider provider)
        {
