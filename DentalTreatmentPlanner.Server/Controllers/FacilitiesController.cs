...
namespace DentalTreatmentPlanner.Server.Controllers
{
    public class FacilitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FacilityId,Name,Street,Suite,ZipCode,City,CreatedAt,ModifiedAt")] Facility facility)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FacilityId,Name,Street,Suite,ZipCode,City,CreatedAt,ModifiedAt")] Facility facility)
        {
