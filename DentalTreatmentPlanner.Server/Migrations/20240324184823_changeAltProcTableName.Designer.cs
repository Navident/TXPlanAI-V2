...
namespace DentalTreatmentPlanner.Server.Migrations
{
    ...
    [Migration("20240324184823_changeAltProcTableName")]
    partial class changeAltProcTableName
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DentalTreatmentPlanner.Server.Models.VisitCdtCodeMap", b =>
                {
                    ...
                    b.HasOne("DentalTreatmentPlanner.Server.Models.DefToAltProcMap", "DefToAltProcMap")
                        .WithMany("VisitCdtCodeMaps")
                        .HasForeignKey("DefToAltProcMapId");
