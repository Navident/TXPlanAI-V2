...
namespace DentalTreatmentPlanner.Server.Migrations
{
    ...
    [Migration("20240325085240_personalupdates")]
    partial class personalupdates
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DentalTreatmentPlanner.Server.Models.VisitCdtCodeMap", b =>
                {
                    ...
                    b.Property<int?>("ChosenAltCdtCodeId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DentalTreatmentPlanner.Server.Models.VisitCdtCodeMap", b =>
                {
                    ...
                    b.HasOne("DentalTreatmentPlanner.Server.Models.CdtCode", "ChosenAltCdtCode")
                        .WithMany()
                        .HasForeignKey("ChosenAltCdtCodeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("FK_VisitCdtCodeMap_ChosenAltCdtCode");
