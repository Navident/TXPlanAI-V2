...
namespace DentalTreatmentPlanner.Server.Migrations
{
    ...
    [Migration("20240324030410_nullableAlternaativeProcedureCdtCodeId")]
    partial class nullableAlternaativeProcedureCdtCodeId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DentalTreatmentPlanner.Server.Models.AlternativeProcedure", b =>
                {
                    ...
                    b.HasOne("DentalTreatmentPlanner.Server.Models.VisitCdtCodeMap", "VisitCdtCodeMap")
                        .WithOne("AlternativeProcedure")
                        .HasForeignKey("DentalTreatmentPlanner.Server.Models.AlternativeProcedure", "VisitCdtCodeMapId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
