...
namespace DentalTreatmentPlanner.Server.Migrations
{
    ...
    [Migration("20240325180206_personalchangesv2")]
    partial class personalchangesv2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DentalTreatmentPlanner.Server.Models.DefToAltProcMap", b =>
                {
                    b.Property<int>("DefToAltProcMapId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DefToAltProcMapId"));

                    b.Property<int?>("AlternativeProcedureCdtCodeId")
                        .HasColumnType("int");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("datetime2");

                    b.Property<int?>("DefaultCdtCodeId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("DefToAltProcMapId");

                    b.HasIndex("AlternativeProcedureCdtCodeId");

                    b.HasIndex("DefaultCdtCodeId");

                    b.HasIndex("VisitCdtCodeMapId");

                    b.ToTable("DefToAltProcMap");
                });
            ...
            modelBuilder.Entity("DentalTreatmentPlanner.Server.Models.VisitCdtCodeMap", b =>
                {
                    ...
                    b.Property<int?>("ChosenAltCdtCodeCdtCodeId")
                        .HasColumnType("int");

                    b.Property<int?>("ChosenDefToAltProcMapId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ChosenAltCdtCodeCdtCodeId");

                    b.HasIndex("ChosenDefToAltProcMapId");
            ...
            modelBuilder.Entity("DentalTreatmentPlanner.Server.Models.DefToAltProcMap", b =>
                {
                    b.HasOne("DentalTreatmentPlanner.Server.Models.CdtCode", "AlternativeProcedureCdtCode")
                        .WithMany()
                        .HasForeignKey("AlternativeProcedureCdtCodeId");

                    b.HasOne("DentalTreatmentPlanner.Server.Models.CdtCode", "DefaultCdtCode")
                        .WithMany()
                        .HasForeignKey("DefaultCdtCodeId");

                    b.HasOne("DentalTreatmentPlanner.Server.Models.VisitCdtCodeMap", "VisitCdtCodeMap")
                        .WithMany("DefToAltProcMaps")
                        .HasForeignKey("VisitCdtCodeMapId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AlternativeProcedureCdtCode");

                    b.Navigation("DefaultCdtCode");
            ...
            modelBuilder.Entity("DentalTreatmentPlanner.Server.Models.VisitCdtCodeMap", b =>
                {
                    b.HasOne("DentalTreatmentPlanner.Server.Models.CdtCode", "CdtCode")
                        ...
                        .IsRequired()
                        .HasConstraintName("FK_VisitCdtCodeMap_CdtCode");

                    b.HasOne("DentalTreatmentPlanner.Server.Models.CdtCode", "ChosenAltCdtCode")
                        .WithMany()
                        .HasForeignKey("ChosenAltCdtCodeCdtCodeId");

                    b.HasOne("DentalTreatmentPlanner.Server.Models.DefToAltProcMap", "ChosenDefToAltProcMap")
                        .WithMany()
                        .HasForeignKey("ChosenDefToAltProcMapId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("FK_VisitCdtCodeMap_ChosenDefToAltProcMap");
                    ...
                    b.Navigation("ChosenAltCdtCode");

                    b.Navigation("ChosenDefToAltProcMap");
