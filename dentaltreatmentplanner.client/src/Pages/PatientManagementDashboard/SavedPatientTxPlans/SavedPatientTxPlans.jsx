...
import { getTreatmentPlansByPatient, deleteTreatmentPlanById } from '../../../ClientServices/apiService';
...
const SavedPatientTxPlans = () => {
    ...
    const handleOpenClick = (planId) => {
        const selectedPlan = localTreatmentPlans.find(plan => plan.treatmentPlanId === planId);
        navigate(`/PatientManagementDashboard/saved-patient-tx-plans/${patientId}/customize-treatment-plan/${planId}`, {
            state: { selectedTreatmentPlan: selectedPlan },
        });
    };
