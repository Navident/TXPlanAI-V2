...
const GenerateTreatmentPlan = () => {
    ...
    const [existingInputText, setExistingInputText] = useState("");
    const [conditionsInputText, setConditionsInputText] = useState("");
    ...
    const processAudioFile = async (audioFile) => {
        ...
        if (transcribedText) {
            const categorizedText = await postProcessTranscriptWithGPT(transcribedText);
            if (categorizedText) {
                setExistingInputText(categorizedText.Existing.join('\n'));
                setConditionsInputText(categorizedText.Conditions.join('\n'));
                setTreatmentsInputText(categorizedText.Treatments.join('\n'));
            }
        }
            ...
            <div className="create-treatment-plan-section rounded-box box-shadow">
                <div className="create-treatment-plan-section-inner">
                    ...
                    <div className="textfield-row">
                        <MultilineTextfield
                            label="Existing"
                            value={existingInputText}
                            onChange={(e) => setExistingInputText(e.target.value)}
                        />
                        <MicIcon
                        ...
                        <MultilineTextfield
                            label="Conditions"
                            value={conditionsInputText}
                            onChange={(e) => setConditionsInputText(e.target.value)}
                        />
                    </div>

                    <MultilineTextfield
                        label="Treatments"
                        value={treatmentsInputText}
                        onChange={(e) => setTreatmentsInputText(e.target.value)}
                    />
