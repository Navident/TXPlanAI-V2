...
const SideBar = () => {
    ...
    const items = [
        ...
        { imgSrc: newTxPlanIcon, imgSrcSelected: newTxPlanIcon, text: "New Tx Plan", path: "newTxPlan" },
        ...
        { imgSrc: cdtCodesIcon, imgSrcSelected: cdtCodesIcon, text: "Custom CDT Codes", path: "customizeCDTCodes" },
